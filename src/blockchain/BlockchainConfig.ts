export class BlockchainConfig {
    ...
    public static configValueAssertionArray: Array<[string, any]> = [
    ...
    // (10k) https://github.com/steemit/steem/commit/292f3414bdcb0557db87181248dca65d7512e820
    public static ACCOUNT_HISTORY_MAX_BATCH_SIZE = 10000;
}
